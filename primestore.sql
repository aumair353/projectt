CREATE DATABASE  IF NOT EXISTS `primestore` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `primestore`;
...
CREATE TABLE `reviews` (
  ...
  `comments` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT 'actual content or text user posted when user reviewed the product.',
  `date_added` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id_fk_idx` (`user_id`),
...
-- Dump completed on 2018-11-11 23:03:34
