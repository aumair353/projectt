...
<div class="container">
    ...
    <div class="col-md-4">
    <div class="card">
        <div class="card-header"><h2>Become A Seller</h2></div>
        <div class="card-body">
            <form action="create-shop.php" method="post">
                ...
                <div class="form-group">
                    <label for="pwd">Business Address:</label>
                    <input type="text" class="form-control" placeholder="Enter address" name="b_address">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Enter type" name="type" value="seller" hidden>
                </div>
                <div class="form-group">
                    <label for="pwd">Shop Title:</label>
                    <input type="text" class="form-control" placeholder="Enter shop title" name="shop_title">
                </div>
               <button type="submit" name="seller_signup" class="btn btn-primary">Sign up</button>
            </form>
        </div>
    </div>
    </div>
...
if(isset($_POST['seller_signup'])){
    ...
    $sql= "insert into users values('$id','$name','$email','$password','$address','$type','$title')";
    $result=mysqli_query($conn,$sql);

    $sql = "SELECT id from users" . " where name= '$name' && email ='$email'";
