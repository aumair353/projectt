...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header"><h2>Become A Customer</h2></div>
                <div class="card-body">
                    <form action="create-new-customer.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter type" name="type" value="customer" hidden>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter shop title" name="shop_title" value="" hidden>
                        </div>
                        <button type="submit" name="c_signup" class="btn btn-primary">Sign up</button>
                    </form>
                </div>
            </div>
        </div>
