...
$(document).ready(function(){
	...
	$(fields).blur(function(){
		var data=$("#email").val();
		$("#result").load("checker.php",{u_name:data});
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            if(isset($_GET['message'])) {
                echo "<h1 class='text-uppercase font-weight-bold'>". $_GET["message"]. "</h1>";
            }
            ?>
        ...
        <div class="card-body">
            <form action="login.php" method="post">
			   ...
			   <div class="form-group">
                ...
                <button type="submit" name="signin"id="button" class="btn btn-primary">Log In</button>
            </form>
    ...
    if($d_password==$password) {
      ...
      //  echo "psvd match";
        ...
        if ($type == "customer") {
            ...
            session_start();
            $_SESSION['id']=$d_id;
            header("location: index.php?id=$d_id");
        }
        ...
        echo "<div class='card bg-secondary text-white col-md-4 ml-auto'>";
        echo "<div class='card-body'>";
        echo "<h6 class='text-uppercase'>Enter Correct Password</h6>";
        echo "</div>";
        echo "</div>";
    }
